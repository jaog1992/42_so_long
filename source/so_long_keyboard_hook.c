...
void	ft_keyboard_up(int keyhook, Mapa *mapa1)
{
...
void	ft_keyboard_left(int keyhook, Mapa *mapa1)
{
...
void	ft_keyboard_down(int keyhook, Mapa *mapa1)
{
...
void	ft_keyboard_right(int keyhook, Mapa *mapa1)
{
